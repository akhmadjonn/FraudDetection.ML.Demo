...
echo "====================================="
echo "Deploying Fraud Detection (PRODUCTION)"
echo "====================================="
...
echo ""
echo "⚠️  PRODUCTION DEPLOYMENT - Please confirm you want to continue"
...
docker config create fraud-detection-settings-prod-${SETTINGS_VERSION} settings.json 2>/dev/null || true
...
echo ""
echo "View logs:"
echo "  docker service logs -f fraud-detection-prod_fraud-detection-api"
echo "  docker service logs -f fraud-detection-prod_fraud-detection-background"
echo ""
echo "Check health:"
echo "  curl https://detection-service.afs.beelab.uz/health"
